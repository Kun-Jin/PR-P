...
data=data_o.iloc[:,'xiadan','temperature','rain']
...
X_train.columns=["Demand-1","Demand-2","Demand-3","Demand-4","Demand-5","Precipitation","Temperature"]

X_test.columns=["Demand-1","Demand-2","Demand-3","Demand-4","Demand-5","Precipitation","Temperature"]
