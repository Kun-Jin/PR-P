...
data_o = pd.read_csv(r'./first_clustering.csv',encoding='gbk')
data=data_o.loc[:,['xiadan','xiadan-1','xiadan-2','xiadan-3','xiadan-4','xiadan-5','xiadan-6','xiadan-7','temperature','rain']]
...
X_train.columns=["Demand-1","Demand-2","Demand-3","Demand-4","Demand-5","Demand-6","Demand-7","Precipitation","Temperature"]

X_test.columns=["Demand-1","Demand-2","Demand-3","Demand-4","Demand-5","Demand-6","Demand-7","Precipitation","Temperature"]
...
plt.tight_layout()
plt.savefig('summary_plot_deep_pattern1.pdf')

plt.figure()
shap.summary_plot(shap_values, X_train, plot_type="bar",show=False)
plt.xlabel("The mean of the absolute of SHAP value")
plt.tight_layout()
plt.savefig('summary_plot_bar_deep_pattern1.pdf')
# plt.figure(3)
...
# plt.tight_layout()
# plt.savefig('dependence_plot_pattern1.pdf')

# plt.figure()
# shap.dependence_plot("Railway passenger flow-1", shap_values, X_train,show=False)
# plt.tight_layout()
# plt.savefig('dependence_plot_passenger1_pattern1.pdf')
