from keras.layers import Input, Dense, LSTM, Conv1D,Dropout,Bidirectional,Multiply,Flatten
...
def attention_model():
    ...
    output = Dense(500, activation='sigmoid')(attention_mul)
    output = Dense(200, activation='sigmoid')(output)
...
m.fit([train_X], train_Y, epochs=1000, batch_size=64,verbose=2)
#m.save("./model.h5")
